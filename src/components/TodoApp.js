      ...
      <div className="bg-white rounded-xl shadow-lg p-8 w-full max-w-md">
        ...
        <form onSubmit={addTodo} className="flex items-center gap-2 mb-6">
          <input 
            ...
            className="flex-1 px-4 py-2 border border-purple-300 rounded-md focus:outline-none focus:ring-2 focus:ring-purple-500"
          />
          <button 
            type="submit" 
...
<footer className="bg-purple-900 text-white mt-10 py-4 px-6">
